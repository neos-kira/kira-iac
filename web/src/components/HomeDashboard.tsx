      ...
      {sidebarOpen && (
        <aside className="hidden md:flex w-[200px] flex-shrink-0 flex-col h-[calc(100vh-3.5rem)] sticky top-14 border-r border-slate-100 bg-white overflow-y-auto">
          ...
          <div className="px-2 py-3 border-t border-slate-100">
            <button type="button" onClick={() => setSidebarOpen(false)} className="w-full flex items-center gap-2 rounded-lg px-3 py-2 text-[12px] text-slate-500 hover:bg-slate-50 hover:text-slate-700 transition-colors">
              <svg className="w-3.5 h-3.5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}><path strokeLinecap="round" strokeLinejoin="round" d="M11 19l-7-7 7-7m8 14l-7-7 7-7" /></svg>
              サイドバーを閉じる
            </button>
          </div>
        </aside>
                            ...
                            <div className="flex items-center justify-between gap-2">
                              ...
                              {isDone ? (
                                ...
                                <div className="flex items-center gap-2 shrink-0">
                                  <span className="inline-flex items-center gap-0.5 rounded-full bg-slate-100 px-2 py-0.5 text-[10px] font-medium text-slate-400">
                                    <svg className="w-3 h-3 mr-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" /></svg>
                                    未解放
                                  </span>
