...
export const LINUX_LEVEL1_QUESTIONS: QuizQuestion[] = [
  ...
  // 第2部: サーバ構築必須 (q11–q20)
  { id: 'q11', prompt: 'apache2をインストールするには？（Ubuntu）', choices: ['apt install apache2 -y'], correctIndex: 0, alternatives: ['apt install apache2'] },
  ...
  { id: 'q17', prompt: 'ufwでポート80（http）を許可するには？', choices: ['ufw allow 80'], correctIndex: 0, alternatives: ['ufw allow http'] },
  { id: 'q18', prompt: 'ufwの設定を反映するには？', choices: ['ufw reload'], correctIndex: 0 },
  ...
  { id: 'q26', prompt: 'apache2.conf内でListenという文字列が含まれる行を確認するには？', choices: ['grep Listen /etc/apache2/apache2.conf'], correctIndex: 0 },
