              ...
              <div className="flex min-w-0" style={{ minWidth: 180 + chartWidthPx + 100 }}>
                ...
                <div className="flex shrink-0 flex-col" style={{ width: 180 }}>
                  ...
                  {ganttRows.map((row, idx) => {
                    const colors = TASK_COLORS[row.taskIndex]
                    return (
                      <div
        ...
        <section>
          ...
          <div className="space-y-4">
            {progressList.map((task, taskIndex) => {
              const colors = TASK_COLORS[taskIndex] ?? TASK_COLORS[0]
              return (
                <article
                  key={task.id}
                  ...
                  style={{
                    borderLeftColor:
                      taskIndex === 0 ? 'rgb(14 165 233)' : taskIndex === 1 ? 'rgb(245 158 11)' : 'rgb(139 92 246)',
                  }}
                >
