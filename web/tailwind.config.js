  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        'body':        ['13px', { lineHeight: '1.75', letterSpacing: '-0.01em',  fontWeight: '500' }],
        'label':       ['11px', { lineHeight: '1.55', letterSpacing: '0.02em',   fontWeight: '500' }],
        ...
        'body-pc':     ['15px', { lineHeight: '1.65', letterSpacing: '-0.01em',  fontWeight: '400' }],
